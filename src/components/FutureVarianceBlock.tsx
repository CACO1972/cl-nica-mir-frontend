...
export function FutureVarianceBlock() {
  ...
  return (
    <section ref={sectionRef} className="px-4 py-section bg-background text-foreground">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-3">
          ...
          <h2
            className="text-xl md:text-2xl font-semibold leading-snug text-foreground"
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <span className="font-semibold"> $200.000 CLP</span> y otro uno de
            <span className="font-semibold"> $28.000.000 CLP</span>.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-4 flex flex-col justify-between">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <span className="font-semibold"> $200.000 CLP</span>.
              </p>
            </div>
            <div className="mt-4 text-xs text-muted-foreground">
              <p className="font-semibold mb-1">A 3–5 años, si no se hace nada más:</p>
          ...
          <div className="rounded-2xl border border-border bg-card p-4 flex flex-col justify-between">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ...
                puede acercarse a
                <span className="font-semibold"> $28.000.000 CLP</span> en casos extremos.
              </p>
            </div>
            <div className="mt-4 text-xs text-muted-foreground">
              <p className="font-semibold mb-1">A 3–5 años, si se mantiene el control:</p>
              <ul className="list-disc list-inside space-y-1">
        ...
        <div className="space-y-3 text-sm">
          ...
          <p className="text-muted-foreground">
            En vez de comparar solo presupuestos, comparas <strong>futuros posibles</strong> y
