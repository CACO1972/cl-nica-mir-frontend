...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "wizard.step7.item1": "Diagnóstico avanzado con imágenes clínicas y análisis con IA en tiempo real.",
    "wizard.step7.item2": "Planificación visual con overlays sobre la radiografía para comprender riesgos y alternativas.",
    "wizard.step7.item3": "Documento 'Explica' en PDF con diagnóstico, opciones A/B, plan, tiempos y presupuesto.",
  ...
  en: {
    ...
    "wizard.step7.item1": "Advanced diagnostics with clinical images and real-time AI analysis.",
    "wizard.step7.item2": "Visual planning with overlays on radiographs to understand risks and alternatives.",
    "wizard.step7.item3": "'Explica' PDF document with diagnosis, A/B options, plan, timelines and budget.",
